    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'manager'), ('sales', 'sales'), ('support', 'support')], default='else', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('in process', 'in process'), ('finished', 'finished')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('event_status', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user.eventstatu')),
                ('sales_contact', models.ForeignKey(limit_choices_to={'role': 'sales'}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='event_sales_contact', to=settings.AUTH_USER_MODEL)),
                ('support_contact', models.ForeignKey(limit_choices_to={'role': 'support'}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='event_support_contact', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
